...
<head>
    ...
    <title><?= Html::encode($lang_arr['title']) ?></title>
    <?php $this->head() ?>
</head>
<body>
<?php $this->beginBody();?>
...
<script>
    function chnglang() {
        var jqxhr = $.post('/user/set-lang',{lang:$("#ulang").val()}, function (data) { document.location.reload() });
        jqxhr.always(function() { document.location.reload() });
